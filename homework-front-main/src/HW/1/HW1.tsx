...
export const HW1 = () => {
    ...
    return (
        <div id={'hw01'}>
            <h1>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium, debitis dolores enim fugit hic
                in, itaque minus perspiciatis quasi rem veniam voluptatibus! Aperiam debitis eius excepturi impedit
                ipsam non sint!</h1>
